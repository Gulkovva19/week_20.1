...
document.addEventListener("DOMContentLoaded", function (event) {
    let heroes = JSON.parse(superJson);
    console.log(heroes);
    ...
    for (let hero of heroes) {
        ...
        <p>${hero.detail}</p>
        <input type="text" class="rating" name="${hero.code}" placeholder="Рейтинг">
        <div class="rating__value" id="value_${hero.number}"></div>
        </div>`;
    }
    ...
    btn.addEventListener('click', () => {
        ...
        for (let i = 0; i < ratings.length; i++) {
            ...
            localStorage.setItem(`${rating.name}`, rating.value);

            document.getElementById('value_1').innerHTML = localStorage.getItem(`batman`);
            document.getElementById('value_2').innerHTML = localStorage.getItem(`superman`);
            document.getElementById(`value_3`).innerHTML = localStorage.getItem(`ironman`);
            document.getElementById(`value_4`).innerHTML = localStorage.getItem(`spiderman`);
            document.getElementById(`value_5`).innerHTML = localStorage.getItem(`captainamerica`);
            document.getElementById(`value_6`).innerHTML = localStorage.getItem(`thor`);
            document.getElementById(`value_7`).innerHTML = localStorage.getItem(`hulk`);
            document.getElementById(`value_8`).innerHTML = localStorage.getItem(`wonderwoman`);
            document.getElementById(`value_9`).innerHTML = localStorage.getItem(`blackwidow`);
            document.getElementById(`value_10`).innerHTML = localStorage.getItem(`deadpool`);
        }
